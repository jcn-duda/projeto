...
export function actionError(outcome: ActionOutcome): string | null {
  ...
  // A recusa do gate (429) já chega traduzida do `api.ts`, que lê o `reason`
  // do corpo — casar o texto aqui era inerte: o 429 nunca carregava a mensagem
  // do backend até o cliente.
