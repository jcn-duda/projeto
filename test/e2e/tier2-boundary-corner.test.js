...
const { createDiagnosticGate, authorized } = require('../../src/utils/diagnostic-guard');
const debrid = require('../../src/debrid');
const debridCommon = require('../../src/debrid/common');
const protectedHashes = require('../../src/debrid/protected');
const jackettCatalog = require('../../src/providers/jackett-catalog');
const prowlarr = require('../../src/providers/prowlarr');
const brResolvers = require('../../src/br-resolvers');
const bludvResolver = require('../../bludv-resolver/server');
const nerdfilmesResolver = require('../../nerdfilmes-resolver/server');
const torrentdosfilmesResolver = require('../../torrentdosfilmes-resolver/server');
const comandotorrentsResolver = require('../../comandotorrents-resolver/server');
