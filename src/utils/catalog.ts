...
export { planDedup, applyDeletions, planWorkVersions } from './catalog-dedup.js';
export type { DedupRow, DedupGroup, Deletion, WorkVersionRow, WorkVersionGroup } from './catalog-dedup.js';
