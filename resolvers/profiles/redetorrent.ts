...
import type { RedeWork } from './redetorrent-parsers.js';
...
function createResolver(overrides: ProfileOverrides = {}) {
  ...
  function selectSearchPosts(sourceHtml: string, query: string, requestedSeason: RegExpMatchArray | null): RedeWork[] {
  ...
  async function postToItems(post: RedeWork, requestedSeason: RegExpMatchArray | null) {
