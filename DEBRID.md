...
## Configuração ao vivo do autofetch (`/painel#chupim`)
...
podem ser ajustados ao vivo pelo operador na aba `[Chupim]` do
painel (`/painel#chupim`), protegidos por `JACKETT_TEST_TOKEN`.
