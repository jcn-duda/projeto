...
function hasAllowedHost(hostname: string | null | undefined, suffixes: string[]): boolean {
 ...
 */
function normalizeHostSuffixes(value: string | string[] | null | undefined): string[] {
