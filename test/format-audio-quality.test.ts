...
// áudio e qualidade — classificação de rótulos, blob de tags do hdrtorrent e
// prova de áudio EN (o balde de resolução desconhecida e o tamanho fabricado
// saíram para test/format-unknown-quality.test.ts).
